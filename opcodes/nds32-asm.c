...
#define DSP_ONEOP(n) ((n) << 10)
  ...
  {"sunpkd832", "=rt,%ra",	ALU2_2 (ONEOP) | DSP_ONEOP (0xb), 4, ATTR (DSP_ISAEXT), 0, NULL, 0, NULL},
  {"zunpkd832", "=rt,%ra",	ALU2_2 (ONEOP) | DSP_ONEOP (0xf), 4, ATTR (DSP_ISAEXT), 0, NULL, 0, NULL},
  ...
  {"kdmabb", "=rt,%ra,%rb",	ALU2_3 (KDMABB), 4, ATTR (DSP2_ISAEXT), 0, NULL, 0, NULL},
  {"kdmabt", "=rt,%ra,%rb",	ALU2_3 (KDMABT), 4, ATTR (DSP2_ISAEXT), 0, NULL, 0, NULL},
  {"kdmatt", "=rt,%ra,%rb",	ALU2_3 (KDMATT), 4, ATTR (DSP2_ISAEXT), 0, NULL, 0, NULL},
  ...
  /* ALU2 Bit 9-6 = 0100.  */
  {"kmmawb2", "=rt,%ra,%rb",	ALU2_4 (KMMAWB2), 4, ATTR (DSP2_ISAEXT), 0, NULL, 0, NULL},
  {"kmmawb2.u", "=rt,%ra,%rb",	ALU2_4 (KMMAWB2u), 4, ATTR (DSP2_ISAEXT), 0, NULL, 0, NULL},
  {"kmmawt2", "=rt,%ra,%rb",	ALU2_4 (KMMAWT2), 4, ATTR (DSP2_ISAEXT), 0, NULL, 0, NULL},
  {"kmmawt2.u", "=rt,%ra,%rb",	ALU2_4 (KMMAWT2u), 4, ATTR (DSP2_ISAEXT), 0, NULL, 0, NULL},
  {"kmmwb2", "=rt,%ra,%rb",	ALU2_4 (KMMWB2), 4, ATTR (DSP2_ISAEXT), 0, NULL, 0, NULL},
  {"kmmwb2.u", "=rt,%ra,%rb",	ALU2_4 (KMMWB2u), 4, ATTR (DSP2_ISAEXT), 0, NULL, 0, NULL},
  {"kmmwt2", "=rt,%ra,%rb",	ALU2_4 (KMMWT2), 4, ATTR (DSP2_ISAEXT), 0, NULL, 0, NULL},
  {"kmmwt2.u", "=rt,%ra,%rb",	ALU2_4 (KMMWT2u), 4, ATTR (DSP2_ISAEXT), 0, NULL, 0, NULL},
  {"smaqa", "=rt,%ra,%rb",	ALU2_4 (SMAQA), 4, ATTR (DSP2_ISAEXT), 0, NULL, 0, NULL},
  {"smaqa.su", "=rt,%ra,%rb",	ALU2_4 (SMAQASU), 4, ATTR (DSP2_ISAEXT), 0, NULL, 0, NULL},
  {"umaqa", "=rt,%ra,%rb",	ALU2_4 (UMAQA), 4, ATTR (DSP2_ISAEXT), 0, NULL, 0, NULL},
