...
static int parse_pi5 (struct nds32_asm_desc *desc, struct nds32_asm_insn *insn,
        char **str, int64_t *value);
static int parse_aext_reg (struct nds32_asm_desc *desc, char **pstr,
...
const field_t operand_fields[] =
{
  ...
  {"sh", 5, 5, 0, HW_UINT, NULL},
  {"sv", 8, 2, 0, HW_UINT, NULL},
  {"dt", 21, 1, 0, HW_DXR, NULL},
  {"usr", 10, 10, 0, HW_USR, NULL},
  {"sr", 10, 10, 0, HW_SR, NULL},
  {"ridx", 10, 10, 0, HW_UINT, NULL},
  {"enb4", 6, 4, 0, HW_UINT, NULL},
  ...
  {"rt38", 8, 3, 0, HW_GPR, NULL},
  {"ra3", 3, 3, 0, HW_GPR, NULL},
  {"rb3", 0, 3, 0, HW_GPR, NULL},
  {"rt5e", 4, 4, 1, HW_GPR, NULL},
  {"ra5e", 0, 4, 1, HW_GPR, NULL},
  {"re2", 5, 2, 0, HW_GPR, parse_re2},
  {"fe5", 0, 5, 2, HW_UINT, parse_fe5},
  {"pi5", 0, 5, 0, HW_UINT, parse_pi5},
  {"abdim", 2, 3, 0, HW_ABDIM, NULL},
  {"abm", 2, 3, 0, HW_ABM, NULL},
  ...
  {"ib5u", 10, 5, 0, HW_UINT, NULL},
  {"ib5s", 10, 5, 0, HW_INT, NULL},
  {"ia3u", 3, 3, 0, HW_UINT, NULL},
  {"i8u", 0, 8, 0, HW_UINT, NULL},
  {"ib8u", 7, 8, 0, HW_UINT, NULL},
  ...
  {"i5u3", 0, 5, 3, HW_UINT, NULL},
  {"i15s3", 0, 15, 3, HW_INT, NULL},
  {"ib4u", 10, 4, 0, HW_UINT, NULL},
  {"ib2u", 10, 2, 0, HW_UINT, NULL},
  {"a_rt", 15, 5, 0, HW_GPR, NULL},
  {"a_ru", 10, 5, 0, HW_GPR, NULL},
  {"a_dx", 9, 1, 0, HW_DXR, NULL},
  {"a_a30", 16, 4, 0, HW_GPR, parse_a30b20},
  {"a_b20", 12, 4, 0, HW_GPR, parse_a30b20},
  {"a_rt21", 5, 7, 0, HW_GPR, parse_rt21},
  {"a_rte", 5, 7, 0, HW_GPR, parse_rte_start},
  {"a_rte1", 5, 7, 0, HW_GPR, parse_rte_end},
  {"a_rte69", 6, 4, 0, HW_GPR, parse_rte69_start},
  {"a_rte69_1", 6, 4, 0, HW_GPR, parse_rte69_end},
  {"dhy", 5, 2, 0, HW_AEXT_ACC, NULL},
  {"dxh", 15, 2, 0, HW_AEXT_ACC, NULL},
  {"aridx", 0, 5, 0, HW_AEXT_ARIDX, NULL},
  {"aridx2", 0, 5, 0, HW_AEXT_ARIDX2, NULL},
  {"aridxi", 16, 4, 0, HW_AEXT_ARIDXI, NULL},
  {"aridxi_mx", 16, 4, 0, HW_AEXT_ARIDXI_MX, NULL},
  {"imm16s", 0, 16, 0, HW_INT, NULL},
  {"imm16u", 0, 16, 0, HW_UINT, NULL},
  {"im5_i", 0, 5, 0, HW_AEXT_IM_I, parse_im5_ip},
  {"im5_m", 0, 5, 0, HW_AEXT_IM_M, parse_im5_mr},
  {"im6_ip", 0, 2, 0, HW_AEXT_IM_I, parse_im6_ip},
  {"im6_iq", 0, 2, 0, HW_AEXT_IM_I, parse_im6_iq},
  {"im6_mr", 2, 2, 0, HW_AEXT_IM_M, parse_im6_mr},
  {"im6_ms", 4, 2, 0, HW_AEXT_IM_M, parse_im6_ms},
  {"cp45", 4, 2, 0, HW_CP, NULL},
  {"i12u", 8, 12, 0, HW_UINT, NULL},
  {"cpi19", 6, 19, 0, HW_UINT, NULL},
  {NULL, 0, 0, 0, 0, NULL}
};
