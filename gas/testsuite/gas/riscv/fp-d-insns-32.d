...
0+ <D>:
[ 	]+[0-9a-f]+:[ 	]+22002fd3[ 	]+fabs\.d[ 	]+f31,f0[ 	]+[0-9a-f]+:[ 	]+R_RISCV_RELAX_ENTRY[ 	]+\*ABS\*
...
[ 	]+[0-9a-f]+:[ 	]+00003f87[ 	]+fld[ 	]+f31,0\(x0\) # 0x0( <.*>)?
[ 	]+[0-9a-f]+:[ 	]+7ff03007[ 	]+fld[ 	]+f0,2047\(x0\) # 0x7ff( <.*>)?
[ 	]+[0-9a-f]+:[ 	]+80003007[ 	]+fld[ 	]+f0,-2048\(x0\) # 0xfffff800( <.*>)?
[ 	]+[0-9a-f]+:[ 	]+000fb007[ 	]+fld[ 	]+f0,0\(x31\)
[ 	]+[0-9a-f]+:[ 	]+00000f97[ 	]+auipc[ 	]+x31,0x0[ 	]+[0-9a-f]+:[ 	]+R_RISCV_PCREL_HI20[ 	]+dval
[ 	]+[0-9a-f]+:[ 	]+R_RISCV_RELAX.*
[ 	]+[0-9a-f]+:[ 	]+000fb007[ 	]+fld[ 	]+f0,0\(x31\) # 0x[0-9a-f]+( <.*>)?[ 	]+[0-9a-f]+:[ 	]+R_RISCV_PCREL_LO12_I[ 	]+.*
[ 	]+[0-9a-f]+:[ 	]+R_RISCV_RELAX.*
...
[ 	]+[0-9a-f]+:[ 	]+01f03027[ 	]+fsd[ 	]+f31,0\(x0\) # 0x0( <.*>)?
[ 	]+[0-9a-f]+:[ 	]+00003fa7[ 	]+fsd[ 	]+f0,31\(x0\) # 0x1f( <.*>)?
[ 	]+[0-9a-f]+:[ 	]+fe003027[ 	]+fsd[ 	]+f0,-32\(x0\) # 0xffffffe0( <.*>)?
[ 	]+[0-9a-f]+:[ 	]+000fb027[ 	]+fsd[ 	]+f0,0\(x31\)
[ 	]+[0-9a-f]+:[ 	]+00000f97[ 	]+auipc[ 	]+x31,0x0[ 	]+[0-9a-f]+:[ 	]+R_RISCV_PCREL_HI20[ 	]+dval
[ 	]+[0-9a-f]+:[ 	]+R_RISCV_RELAX.*
[ 	]+[0-9a-f]+:[ 	]+000fb027[ 	]+fsd[ 	]+f0,0\(x31\) # 0x[0-9a-f]+( <.*>)?[ 	]+[0-9a-f]+:[ 	]+R_RISCV_PCREL_LO12_S[ 	]+.*
[ 	]+[0-9a-f]+:[ 	]+R_RISCV_RELAX.*
