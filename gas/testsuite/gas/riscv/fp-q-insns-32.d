...
0+ <Q>:
[ 	]+[0-9a-f]+:[ 	]+26002fd3[ 	]+fabs\.q[ 	]+f31,f0[ 	]+[0-9a-f]+:[ 	]+R_RISCV_RELAX_ENTRY[ 	]+\*ABS\*
...
[ 	]+[0-9a-f]+:[ 	]+a60f8053[ 	]+fle\.q[ 	]+x0,f31,f0
[ 	]+[0-9a-f]+:[ 	]+a7f00053[ 	]+fle\.q[ 	]+x0,f0,f31
[ 	]+[0-9a-f]+:[ 	]+00004f87[ 	]+flq[ 	]+f31,0\(x0\) # 0x0( <.*>)?
[ 	]+[0-9a-f]+:[ 	]+7ff04007[ 	]+flq[ 	]+f0,2047\(x0\) # 0x7ff( <.*>)?
[ 	]+[0-9a-f]+:[ 	]+80004007[ 	]+flq[ 	]+f0,-2048\(x0\) # 0xfffff800( <.*>)?
[ 	]+[0-9a-f]+:[ 	]+000fc007[ 	]+flq[ 	]+f0,0\(x31\)
[ 	]+[0-9a-f]+:[ 	]+00000f97[ 	]+auipc[ 	]+x31,0x0[ 	]+[0-9a-f]+:[ 	]+R_RISCV_PCREL_HI20[ 	]+qvar
[ 	]+[0-9a-f]+:[ 	]+R_RISCV_RELAX.*
[ 	]+[0-9a-f]+:[ 	]+000fc007[ 	]+flq[ 	]+f0,0\(x31\) # 0x[0-9a-f]+( <.*>)?[ 	]+[0-9a-f]+:[ 	]+R_RISCV_PCREL_LO12_I[ 	]+.*
[ 	]+[0-9a-f]+:[ 	]+R_RISCV_RELAX.*
[ 	]+[0-9a-f]+:[ 	]+a6001fd3[ 	]+flt\.q[ 	]+x31,f0,f0
[ 	]+[0-9a-f]+:[ 	]+a60f9053[ 	]+flt\.q[ 	]+x0,f31,f0
[ 	]+[0-9a-f]+:[ 	]+a7f01053[ 	]+flt\.q[ 	]+x0,f0,f31
...
[ 	]+[0-9a-f]+:[ 	]+01f04027[ 	]+fsq[ 	]+f31,0\(x0\) # 0x0( <.*>)?
[ 	]+[0-9a-f]+:[ 	]+00004fa7[ 	]+fsq[ 	]+f0,31\(x0\) # 0x1f( <.*>)?
[ 	]+[0-9a-f]+:[ 	]+fe004027[ 	]+fsq[ 	]+f0,-32\(x0\) # 0xffffffe0( <.*>)?
[ 	]+[0-9a-f]+:[ 	]+000fc027[ 	]+fsq[ 	]+f0,0\(x31\)
[ 	]+[0-9a-f]+:[ 	]+00000f97[ 	]+auipc[ 	]+x31,0x0[ 	]+[0-9a-f]+:[ 	]+R_RISCV_PCREL_HI20[ 	]+qvar
[ 	]+[0-9a-f]+:[ 	]+R_RISCV_RELAX.*
[ 	]+[0-9a-f]+:[ 	]+000fc027[ 	]+fsq[ 	]+f0,0\(x31\) # 0x[0-9a-f]+( <.*>)?[ 	]+[0-9a-f]+:[ 	]+R_RISCV_PCREL_LO12_S[ 	]+.*
[ 	]+[0-9a-f]+:[ 	]+R_RISCV_RELAX.*
