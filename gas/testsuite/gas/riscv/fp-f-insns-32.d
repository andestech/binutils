...
#objdump: -dwrMnumeric -M_no-prefer
...
0+ <F>:
[ 	]+[0-9a-f]+:[ 	]+20002fd3[ 	]+fabs\.s[ 	]+f31,f0[ 	]+[0-9a-f]+:[ 	]+R_RISCV_RELAX_ENTRY[ 	]+\*ABS\*
...
[ 	]+[0-9a-f]+:[ 	]+a00f9053[ 	]+flt\.s[ 	]+x0,f31,f0
[ 	]+[0-9a-f]+:[ 	]+a1f01053[ 	]+flt\.s[ 	]+x0,f0,f31
[ 	]+[0-9a-f]+:[ 	]+00002f87[ 	]+flw[ 	]+f31,0\(x0\) # 0x0( <.*>)?
[ 	]+[0-9a-f]+:[ 	]+7ff02007[ 	]+flw[ 	]+f0,2047\(x0\) # 0x7ff( <.*>)?
[ 	]+[0-9a-f]+:[ 	]+80002007[ 	]+flw[ 	]+f0,-2048\(x0\) # 0xfffff800( <.*>)?
[ 	]+[0-9a-f]+:[ 	]+000fa007[ 	]+flw[ 	]+f0,0\(x31\)
[ 	]+[0-9a-f]+:[ 	]+00000f97[ 	]+auipc[ 	]+x31,0x0[ 	]+[0-9a-f]+:[ 	]+R_RISCV_PCREL_HI20[ 	]+sval
[ 	]+[0-9a-f]+:[ 	]+R_RISCV_RELAX.*
[ 	]+[0-9a-f]+:[ 	]+000fa007[ 	]+flw[ 	]+f0,0\(x31\) # 0x[0-9a-f]+( <.*>)?[ 	]+[0-9a-f]+:[ 	]+R_RISCV_PCREL_LO12_I[ 	]+.*
[ 	]+[0-9a-f]+:[ 	]+R_RISCV_RELAX.*
...
[ 	]+[0-9a-f]+:[ 	]+01f02027[ 	]+fsw[ 	]+f31,0\(x0\) # 0x0( <.*>)?
[ 	]+[0-9a-f]+:[ 	]+00002fa7[ 	]+fsw[ 	]+f0,31\(x0\) # 0x1f( <.*>)?
[ 	]+[0-9a-f]+:[ 	]+fe002027[ 	]+fsw[ 	]+f0,-32\(x0\) # 0xffffffe0( <.*>)?
[ 	]+[0-9a-f]+:[ 	]+000fa027[ 	]+fsw[ 	]+f0,0\(x31\)
[ 	]+[0-9a-f]+:[ 	]+00000f97[ 	]+auipc[ 	]+x31,0x0[ 	]+[0-9a-f]+:[ 	]+R_RISCV_PCREL_HI20[ 	]+sval
[ 	]+[0-9a-f]+:[ 	]+R_RISCV_RELAX.*
[ 	]+[0-9a-f]+:[ 	]+000fa027[ 	]+fsw[ 	]+f0,0\(x31\) # 0x[0-9a-f]+( <.*>)?[ 	]+[0-9a-f]+:[ 	]+R_RISCV_PCREL_LO12_S[ 	]+.*
[ 	]+[0-9a-f]+:[ 	]+R_RISCV_RELAX.*
