...
0+000 <target>:
[	 ]*[0-9a-f]+:[	 ]+c009[	 ]+c.beqz[	 ]+s0,0x2.+
[^:]+: R_RISCV_RELAX_ENTRY[	]+\*ABS\*\-0x80000000
[^:]+: R_RISCV_RVC_BRANCH[	]+C_BRANCH_RANGE

0+2 <C_BRANCH_RANGE>:
[	 ]*[0-9a-f]+:[	 ]+10041263[	 ]+bne[	 ]+s0,zero,0x106.+
[^:]+: R_RISCV_BRANCH[	]+EXPAND_TO_BRANCH
#...

.+ <EXPAND_TO_BRANCH>:
[	 ]*[0-9a-f]+:[	 ]+c019[	 ]+c.beqz[	 ]+s0,0x10c.+
[^:]+: R_RISCV_RVC_BRANCH[	]+\.L0 
[	 ]*[0-9a-f]+:[	 ]+0040106f[	 ]+jal[	 ]+zero,0x110c.+
[^:]+: R_RISCV_JAL[	]+FLIP_C_BRANCH_AND_JUMP
#...

.+ <FLIP_C_BRANCH_AND_JUMP>:
[	 ]*[0-9a-f]+:[	 ]+00041463[	 ]+bne[	 ]+s0,zero,0x1114.+
[^:]+: R_RISCV_BRANCH[	]+\.L0 
[	 ]*[0-9a-f]+:[	 ]+0000006f[	 ]+jal[	 ]+zero,0x1110.+
[^:]+: R_RISCV_JAL[	]+\*ABS\*\-0x4
[	 ]*[0-9a-f]+:[	 ]+8082[	 ]+c.jr[	 ]+ra
