...
#define RV_IMM_SIGN(x) ((bfd_signed_vma)(-(((x) >> 31) & 1)))
...
/* { Andes  */
#define ENCODE_UTYPE_IMM32(x) ENCODE_UTYPE_IMM(x)
#define EXTRACT_UTYPE_IMM32(x) ((RV_X(x, 12, 20) << 12))
#define VALID_UTYPE_IMM32(x) (EXTRACT_UTYPE_IMM32(ENCODE_UTYPE_IMM32(x)) == (x))
/* RVP */
...
#define VALID_RVC_LUI_IMM(x) (EXTRACT_CITYPE_IMM(ENCODE_CITYPE_IMM(x)) == (x))
...
enum riscv_insn_class
{
  ...
  INSN_CLASS_F_AND_ZFHMIN,
  INSN_CLASS_D_AND_ZFHMIN,
  INSN_CLASS_Q_AND_ZFHMIN,
  INSN_CLASS_ZICBOM,
  INSN_CLASS_ZICBOZ,
  INSN_CLASS_ZICBOP,
  INSN_CLASS_F_AND_ZFHMIN_BF16,
  INSN_CLASS_ZFBFMIN,
  INSN_CLASS_ZVFBFMIN,
  INSN_CLASS_ZVFBFWMA,
  /* { Andes  */
