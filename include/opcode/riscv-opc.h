...
/* { zfh */
#ifndef RISCV_ENCODING_H_RVZFH
#define RISCV_ENCODING_H_RVZFH
...
#endif /* DECLARE_INSN_RVZFH */
/* } zfh */

/* { zicbo */
#ifndef RISCV_ENCODING_H_ZICBO
#define RISCV_ENCODING_H_ZICBO
...
DECLARE_CSR(mhpmevent3h, CSR_MHPMEVENT3H, CSR_CLASS_SSCOFPMF, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mhpmevent4h, CSR_MHPMEVENT4H, CSR_CLASS_SSCOFPMF, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mhpmevent5h, CSR_MHPMEVENT5H, CSR_CLASS_SSCOFPMF, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mhpmevent6h, CSR_MHPMEVENT6H, CSR_CLASS_SSCOFPMF, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mhpmevent7h, CSR_MHPMEVENT7H, CSR_CLASS_SSCOFPMF, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mhpmevent8h, CSR_MHPMEVENT8H, CSR_CLASS_SSCOFPMF, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mhpmevent9h, CSR_MHPMEVENT9H, CSR_CLASS_SSCOFPMF, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mhpmevent10h, CSR_MHPMEVENT10H, CSR_CLASS_SSCOFPMF, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mhpmevent11h, CSR_MHPMEVENT11H, CSR_CLASS_SSCOFPMF, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mhpmevent12h, CSR_MHPMEVENT12H, CSR_CLASS_SSCOFPMF, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mhpmevent13h, CSR_MHPMEVENT13H, CSR_CLASS_SSCOFPMF, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mhpmevent14h, CSR_MHPMEVENT14H, CSR_CLASS_SSCOFPMF, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mhpmevent15h, CSR_MHPMEVENT15H, CSR_CLASS_SSCOFPMF, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mhpmevent16h, CSR_MHPMEVENT16H, CSR_CLASS_SSCOFPMF, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mhpmevent17h, CSR_MHPMEVENT17H, CSR_CLASS_SSCOFPMF, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mhpmevent18h, CSR_MHPMEVENT18H, CSR_CLASS_SSCOFPMF, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mhpmevent19h, CSR_MHPMEVENT19H, CSR_CLASS_SSCOFPMF, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mhpmevent20h, CSR_MHPMEVENT20H, CSR_CLASS_SSCOFPMF, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mhpmevent21h, CSR_MHPMEVENT21H, CSR_CLASS_SSCOFPMF, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mhpmevent22h, CSR_MHPMEVENT22H, CSR_CLASS_SSCOFPMF, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mhpmevent23h, CSR_MHPMEVENT23H, CSR_CLASS_SSCOFPMF, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mhpmevent24h, CSR_MHPMEVENT24H, CSR_CLASS_SSCOFPMF, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mhpmevent25h, CSR_MHPMEVENT25H, CSR_CLASS_SSCOFPMF, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mhpmevent26h, CSR_MHPMEVENT26H, CSR_CLASS_SSCOFPMF, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mhpmevent27h, CSR_MHPMEVENT27H, CSR_CLASS_SSCOFPMF, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mhpmevent28h, CSR_MHPMEVENT28H, CSR_CLASS_SSCOFPMF, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mhpmevent29h, CSR_MHPMEVENT29H, CSR_CLASS_SSCOFPMF, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mhpmevent30h, CSR_MHPMEVENT30H, CSR_CLASS_SSCOFPMF, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mhpmevent31h, CSR_MHPMEVENT31H, CSR_CLASS_SSCOFPMF, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(scountovf, CSR_SCOUNTOVF, CSR_CLASS_SSCOFPMF, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
#endif /* DECLARE_CSR_SSCOFPMF */
/* } sscofpmf */

/* { Andes */
/* rv_xnexecit  */
#ifndef RISCV_ENCODING_H_XNEXECIT
#define RISCV_ENCODING_H_XNEXECIT
#define MATCH_NEXEC_IT 0x9000
#define MASK_NEXEC_IT 0xf003
#endif /* RISCV_ENCODING_H_XNEXECIT */
#ifdef DECLARE_INSN
DECLARE_INSN(nexec_it, MATCH_NEXEC_IT, MASK_NEXEC_IT)
#endif /* DECLARE_INSN_XNEXECIT */

/* rvp.h  */
#ifndef RISCV_ENCODING_H_RVP
#define RISCV_ENCODING_H_RVP
...
#endif /* DECLARE_INSN_RVP */
#ifdef DECLARE_CSR
#define CSR_PL8 0xcc0
#define CSR_PL32 0xcc2
#define CSR_PL16 0xcc1
DECLARE_CSR(pl8, CSR_PL8, CSR_CLASS_P, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(pl32, CSR_PL32, CSR_CLASS_P, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(pl16, CSR_PL16, CSR_CLASS_P, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
#endif /* DECLARE_CSR_RVP */

/* rvxandes.h  */
#ifndef RISCV_ENCODING_H_RVXANDES
#define RISCV_ENCODING_H_RVXANDES
...
#define MATCH_FCVT_S_BF16_NDS 0x1405b
#define MASK_FCVT_S_BF16_NDS  0xfe0ff07f
#define MATCH_FCVT_BF16_S_NDS 0x1c05b
#define MASK_FCVT_BF16_S_NDS  0xfe0ff07f
...
#endif /* RISCV_ENCODING_H_RVXANDES */
#ifdef DECLARE_INSN
...
DECLARE_INSN(fcvt_s_bf160, MATCH_FCVT_S_BF16_NDS, MASK_FCVT_S_BF16_NDS)
DECLARE_INSN(fcvt_bf16_s0, MATCH_FCVT_BF16_S_NDS, MASK_FCVT_BF16_S_NDS)
...
#endif /* DECLARE_INSN_RVXANDES */

/* rvxefhw.h  */
#ifndef RISCV_ENCODING_H_RVXEFHW
#define RISCV_ENCODING_H_RVXEFHW
#define MATCH_FLHW 0x7
#define MASK_FLHW 0x707f
#define MATCH_FSHW 0x27
#define MASK_FSHW 0x707f
#endif /* RISCV_ENCODING_H_RVXEFHW */
#ifdef DECLARE_INSN
DECLARE_INSN(flhw, MATCH_FLHW, MASK_FLHW)
DECLARE_INSN(fshw, MATCH_FSHW, MASK_FSHW)
#endif /* DECLARE_INSN_RVXEFHW */

/* rv_bf16  */
#ifndef RISCV_ENCODING_H_RVBF16
#define RISCV_ENCODING_H_RVBF16
...
#define MATCH_VFWMACCBF16_VF 0x8c005057
#define MASK_VFWMACCBF16_VF 0xfc00707f
#define MATCH_VFWMACCBF16_VV 0x8c001057
#define MASK_VFWMACCBF16_VV 0xfc00707f
#endif /* RISCV_ENCODING_H_RVBF16 */
#ifdef DECLARE_INSN
...
#endif /* DECLARE_INSN_BF16 */

/* Resumable NMI proposal-v0.2.1-draft  */
#ifndef RISCV_ENCODING_H_RNMI
#define RISCV_ENCODING_H_RNMI
#define MATCH_MNRET 0x70200073
#define MASK_MNRET  0xffffffff
#endif /* RISCV_ENCODING_H_RNMI */
#ifdef DECLARE_INSN
DECLARE_INSN(mnret, MATCH_MNRET, MASK_MNRET)
#endif /* DECLARE_INSN_RNMI */
...
#ifdef DECLARE_CSR  /* DECLARE_CSR Andes V5 SPA */
DECLARE_CSR(senvcfg, CSR_SENVCFG, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mtvt, CSR_MTVT, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(menvcfg, CSR_MENVCFG, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(menvcfgh, CSR_MENVCFGH, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mnxti, CSR_MNXTI, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mintstatus0, CSR_MINTSTATUS0, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mintstatus, CSR_MINTSTATUS, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mintthresh, CSR_MINTTHRESH, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mscratchcsw, CSR_MSCRATCHCSW, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mscratchcswl, CSR_MSCRATCHCSWL, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(pmpcfg4, CSR_PMPCFG4, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(pmpcfg5, CSR_PMPCFG5, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(pmpcfg6, CSR_PMPCFG6, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(pmpcfg7, CSR_PMPCFG7, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(pmpcfg8, CSR_PMPCFG8, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(pmpcfg9, CSR_PMPCFG9, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(pmpcfg10, CSR_PMPCFG10, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(pmpcfg11, CSR_PMPCFG11, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(pmpcfg12, CSR_PMPCFG12, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(pmpcfg13, CSR_PMPCFG13, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(pmpcfg14, CSR_PMPCFG14, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(pmpcfg15, CSR_PMPCFG15, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(pmpaddr16, CSR_PMPADDR16, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(pmpaddr17, CSR_PMPADDR17, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(pmpaddr18, CSR_PMPADDR18, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(pmpaddr19, CSR_PMPADDR19, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(pmpaddr20, CSR_PMPADDR20, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(pmpaddr21, CSR_PMPADDR21, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(pmpaddr22, CSR_PMPADDR22, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(pmpaddr23, CSR_PMPADDR23, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(pmpaddr24, CSR_PMPADDR24, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(pmpaddr25, CSR_PMPADDR25, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(pmpaddr26, CSR_PMPADDR26, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(pmpaddr27, CSR_PMPADDR27, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(pmpaddr28, CSR_PMPADDR28, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(pmpaddr29, CSR_PMPADDR29, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(pmpaddr30, CSR_PMPADDR30, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(pmpaddr31, CSR_PMPADDR31, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(pmpaddr32, CSR_PMPADDR32, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(pmpaddr33, CSR_PMPADDR33, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(pmpaddr34, CSR_PMPADDR34, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(pmpaddr35, CSR_PMPADDR35, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(pmpaddr36, CSR_PMPADDR36, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(pmpaddr37, CSR_PMPADDR37, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(pmpaddr38, CSR_PMPADDR38, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(pmpaddr39, CSR_PMPADDR39, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(pmpaddr40, CSR_PMPADDR40, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(pmpaddr41, CSR_PMPADDR41, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(pmpaddr42, CSR_PMPADDR42, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(pmpaddr43, CSR_PMPADDR43, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(pmpaddr44, CSR_PMPADDR44, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(pmpaddr45, CSR_PMPADDR45, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(pmpaddr46, CSR_PMPADDR46, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(pmpaddr47, CSR_PMPADDR47, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(pmpaddr48, CSR_PMPADDR48, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(pmpaddr49, CSR_PMPADDR49, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(pmpaddr50, CSR_PMPADDR50, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(pmpaddr51, CSR_PMPADDR51, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(pmpaddr52, CSR_PMPADDR52, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(pmpaddr53, CSR_PMPADDR53, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(pmpaddr54, CSR_PMPADDR54, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(pmpaddr55, CSR_PMPADDR55, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(pmpaddr56, CSR_PMPADDR56, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(pmpaddr57, CSR_PMPADDR57, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(pmpaddr58, CSR_PMPADDR58, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(pmpaddr59, CSR_PMPADDR59, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(pmpaddr60, CSR_PMPADDR60, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(pmpaddr61, CSR_PMPADDR61, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(pmpaddr62, CSR_PMPADDR62, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(pmpaddr63, CSR_PMPADDR63, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mseccfg, CSR_MSECCFG, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mseccfgh, CSR_MSECCFGH, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(milmb, CSR_MILMB, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mdlmb, CSR_MDLMB, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mecc_code, CSR_MECC_CODE, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mnvec, CSR_MNVEC, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mxstatus, CSR_MXSTATUS, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mpft_ctl, CSR_MPFT_CTL, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mhsp_ctl, CSR_MHSP_CTL, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(msp_bound, CSR_MSP_BOUND, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(msp_base, CSR_MSP_BASE, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mdcause, CSR_MDCAUSE, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mcache_ctl, CSR_MCACHE_CTL, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mcctlbeginaddr, CSR_MCCTLBEGINADDR, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mcctlcommand, CSR_MCCTLCOMMAND, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mcctldata, CSR_MCCTLDATA, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mcounterwen, CSR_MCOUNTERWEN, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mcounterinten, CSR_MCOUNTERINTEN, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mmisc_ctl, CSR_MMISC_CTL, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mcountermask_m, CSR_MCOUNTERMASK_M, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mcountermask_s, CSR_MCOUNTERMASK_S, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mcountermask_u, CSR_MCOUNTERMASK_U, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mcounterovf, CSR_MCOUNTEROVF, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mslideleg, CSR_MSLIDELEG, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(msavestatus, CSR_MSAVESTATUS, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(msaveepc1, CSR_MSAVEEPC1, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(msavecause1, CSR_MSAVECAUSE1, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(msaveepc2, CSR_MSAVEEPC2, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(msavecause2, CSR_MSAVECAUSE2, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(msavedcause1, CSR_MSAVEDCAUSE1, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(msavedcause2, CSR_MSAVEDCAUSE2, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mclk_ctl, CSR_MCLK_CTL, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(dexc2dbg, CSR_DEXC2DBG, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(ddcause, CSR_DDCAUSE, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(pushmxstatus, CSR_PUSHMXSTATUS, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mirq_entry, CSR_MIRQ_ENTRY, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mintsel_jal, CSR_MINTSEL_JAL, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(pushmcause, CSR_PUSHMCAUSE, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(pushmepc, CSR_PUSHMEPC, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mppib, CSR_MPPIB, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mfiob, CSR_MFIOB, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mrandseq, CSR_MRANDSEQ, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mrandseqh, CSR_MRANDSEQH, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mrandstate, CSR_MRANDSTATE, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mrandstateh, CSR_MRANDSTATEH, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(uitb, CSR_UITB, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(ucode, CSR_UCODE, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(udcause, CSR_UDCAUSE, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(ucctlbeginaddr, CSR_UCCTLBEGINADDR, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(ucctlcommand, CSR_UCCTLCOMMAND, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(wfe, CSR_WFE, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(sleepvalue, CSR_SLEEPVALUE, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(txevt, CSR_TXEVT, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(slie, CSR_SLIE, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(slip, CSR_SLIP, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(sdcause, CSR_SDCAUSE, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(scctldata, CSR_SCCTLDATA, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(scounterinten, CSR_SCOUNTERINTEN, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(smisc_ctl, CSR_SMISC_CTL, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(scountermask_m, CSR_SCOUNTERMASK_M, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(scountermask_s, CSR_SCOUNTERMASK_S, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(scountermask_u, CSR_SCOUNTERMASK_U, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(scounterovf, CSR_SCOUNTEROVF, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(scountinhibit, CSR_SCOUNTINHIBIT, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(shpmevent3, CSR_SHPMEVENT3, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(shpmevent4, CSR_SHPMEVENT4, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(shpmevent5, CSR_SHPMEVENT5, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(shpmevent6, CSR_SHPMEVENT6, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(pmacfg0, CSR_PMACFG0, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(pmacfg1, CSR_PMACFG1, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(pmacfg2, CSR_PMACFG2, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(pmacfg3, CSR_PMACFG3, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(pmaaddr0, CSR_PMAADDR0, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(pmaaddr1, CSR_PMAADDR1, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(pmaaddr2, CSR_PMAADDR2, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(pmaaddr3, CSR_PMAADDR3, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(pmaaddr4, CSR_PMAADDR4, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(pmaaddr5, CSR_PMAADDR5, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(pmaaddr6, CSR_PMAADDR6, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(pmaaddr7, CSR_PMAADDR7, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(pmaaddr8, CSR_PMAADDR8, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(pmaaddr9, CSR_PMAADDR9, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(pmaaddr10, CSR_PMAADDR10, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(pmaaddr11, CSR_PMAADDR11, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(pmaaddr12, CSR_PMAADDR12, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(pmaaddr13, CSR_PMAADDR13, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(pmaaddr14, CSR_PMAADDR14, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(pmaaddr15, CSR_PMAADDR15, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mconfigptr, CSR_MCONFIGPTR, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(micm_cfg, CSR_MICM_CFG, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mdcm_cfg, CSR_MDCM_CFG, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mmsc_cfg, CSR_MMSC_CFG, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mmsc_cfg2, CSR_MMSC_CFG2, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mmsc_cfg3, CSR_MMSC_CFG3, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mvec_cfg, CSR_MVEC_CFG, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mcrash_statesave, CSR_MCRASH_STATESAVE, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mstatus_crashsave, CSR_MSTATUS_CRASHSAVE, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mrvarch_cfg, CSR_MRVARCH_CFG, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(ml2c_ctl_base, CSR_ML2C_CTL_BASE, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
/* v1.5.48 */
DECLARE_CSR(umisc_ctl, CSR_UMISC_CTL, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(sstateen0, CSR_SSTATEEN0, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(sstateen1, CSR_SSTATEEN1, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(sstateen2, CSR_SSTATEEN2, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(sstateen3, CSR_SSTATEEN3, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mstateen0, CSR_MSTATEEN0, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mstateen1, CSR_MSTATEEN1, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mstateen2, CSR_MSTATEEN2, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mstateen3, CSR_MSTATEEN3, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mstateen0h, CSR_MSTATEEN0H, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mstateen1h, CSR_MSTATEEN1H, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mstateen2h, CSR_MSTATEEN2H, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mstateen3h, CSR_MSTATEEN3H, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
// DECLARE_CSR(mndsx_rdata, CSR_MNDSX_RDATA, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
// DECLARE_CSR(mndsx_wdata, CSR_MNDSX_WDATA, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mrvarch_cfg2, CSR_MRVARCH_CFG2, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mhvm_cfg, CSR_MHVM_CFG, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mhvmb, CSR_MHVMB, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
/* v1.5.55 */
DECLARE_CSR(miselect, CSR_MISELECT, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mireg, CSR_MIREG, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mireg2, CSR_MIREG2, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mireg3, CSR_MIREG3, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mireg4, CSR_MIREG4, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mireg5, CSR_MIREG5, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mireg6, CSR_MIREG6, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(siselect, CSR_SISELECT, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(sireg, CSR_SIREG, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(sireg2, CSR_SIREG2, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(sireg3, CSR_SIREG3, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(sireg4, CSR_SIREG4, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(sireg5, CSR_SIREG5, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(sireg6, CSR_SIREG6, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mrvarch_cfg3, CSR_MRVARCH_CFG3, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mrnxvec, CSR_MRNXVEC, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mnscratch, CSR_MNSCRATCH, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mnepc, CSR_MNEPC, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mncause, CSR_MNCAUSE, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mnstatus, CSR_MNSTATUS, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mcache_ctl2, CSR_MCACHE_CTL2, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mpl2cm_cfg, CSR_MPL2CM_CFG, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
#endif /* DECLARE_CSR Andes V5 SPA */
#ifdef DECLARE_CSR_ALIAS
DECLARE_CSR_ALIAS(mccache_ctl_base, CSR_ML2C_CTL_BASE, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
#endif
/* } Andes  */
