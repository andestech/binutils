...
START_RELOC_NUMBERS (elf_riscv_reloc_type)
  ...
  /* { Andes */
  RELOC_NUMBER (R_RISCV_internal_max, 62)
...
#define R_RISCV_DELETE  (R_RISCV_internal_max)
#define R_RISCV_RVC_LUI (R_RISCV_internal_max + 1)
#define R_RISCV_GPREL_I (R_RISCV_internal_max + 2)
#define R_RISCV_GPREL_S (R_RISCV_internal_max + 3)
#define R_RISCV_TPREL_I (R_RISCV_internal_max + 4)
#define R_RISCV_TPREL_S (R_RISCV_internal_max + 5)
