...
{   unsigned long long insn_cnt;
    ...
    unsigned long long to_fn_call_tag;
    unsigned long long to_fn_rt_tag;
    unsigned long long to_br_tag;
    unsigned long long to_du_call_tag;
    unsigned long long to_du_rt_tag;
...
extern tcgheader tcghdr;
extern tcgfname *tcgfni;
extern char *tcgfnp;
extern tcgpage *tcgpages;
extern tcgnode1 *tcgnodes1;
