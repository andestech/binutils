...
/* This function reads the timeline based profiling data for
   function coverage.
   The expected sequences are 0xc1, {0x11,0x12,0xcf}* and 0xc0.
...
/* This function reads the timeline based profiling data
   for branch coverage.
   The expected sequences are 0xc2, {0x21,0x22,0x23,0xcf}* and 0xc0.
   return code: (execution terminated if any error encountered.)
   0x00 - end-of-file
   tag - next tag  */
...
/* This function reads the timeline based profiling data
   for instruction coverage. The expected sequences are
   0xc3, {0x31,0x32,0x33,0x34,0x35,0xcf}* and 0xc0.
   return code: (execution terminated if any error encountered.)
   0x00 - end-of-file
   tag - next tag  */
...
{   FILE            *ifp;
    ...
    if (gmon_file_version != NDS32_GMON_VERSION && gmon_file_version != 0)
