...
int function_level = 0, min_function_level = 0, max_function_level = 1;
		...
		unsigned int *len)
{
	...
	if((tag == PROFTYPE_FC3) || (tag == PROFTYPE_ON3)){
		...
		buf_index = PlaceData2Buf(to_insn_cnt, 		outrec, 15, buf_index, HIGH_NIBBLE);
		buf_index = PlaceData2Buf(to_cycle_cnt, 		outrec, 15, buf_index, LOW_NIBBLE);
		...
		buf_index = 12;
		buf_index = PlaceData2Buf(to_insn_cnt, 		outrec, 11, buf_index, HIGH_NIBBLE);
		buf_index = PlaceData2Buf(to_cycle_cnt, 		outrec, 11, buf_index, LOW_NIBBLE);
