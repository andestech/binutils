...
static FILE *sym_ld_script = NULL;
static int set_relax_align = 1;
static int target_aligned = 1;
static int gp_relative_insn = 0;
static int avoid_btb_miss = 1;
static int set_relax_lui = 1;
static int set_relax_pc = 1;
static int set_relax_call = 1;
static int set_relax_tls_le = 1;
static int set_relax_cross_section_call = $D4_RCSC;	/* Defalut do relax cross section call.  */

#define RISCV_EXECIT_EXT
static int target_optimize = 0;
static int relax_status = 0;
static char *execit_export_file = NULL;
static FILE *execit_import_file = NULL;
static int keep_import_execit = 0;
static int update_execit_table = 0;
static int execit_limit = -1;
static int execit_loop_aware = 0;
