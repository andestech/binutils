...
#define OPTION_TRUNCATION_CHECK		(OPTION_INTERNAL_BASELINE + 14)
#define OPTION_NO_TRUNCATION_CHECK	(OPTION_INTERNAL_BASELINE + 15)
#define OPTION_MB35102  		(OPTION_INTERNAL_BASELINE + 16)
#define OPTION_MB35102_DETECTOR		(OPTION_INTERNAL_BASELINE + 17)
...
fprintf (file, _("\
    ...
    --m[no-]truncation-check    Disable/Enable the check for relocation truncated to fit\n\
"));
